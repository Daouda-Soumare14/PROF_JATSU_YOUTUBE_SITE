...
<form action="<?=isset($params['post']) ? "/Prof_Jatsu_Youtube_Site/public/admin/posts/edit/{$params['post']->id}"
 : "/Prof_Jatsu_Youtube_Site/public/admin/posts/create" ?>" method="post">
